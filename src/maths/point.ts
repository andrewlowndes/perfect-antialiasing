...
export const multiply = (p1: Point, p2: Point) =>
  vec2.multiply(vec2.create(), p1, p2);
export const divide = (p1: Point, p2: Point) =>
  vec2.divide(vec2.create(), p1, p2);
export const add = (p1: Point, p2: Point) => vec2.add(vec2.create(), p1, p2);
export const adds = (p1: Point, a: number) =>
  vec2.fromValues(p1[0] + a, p1[1] + a);
...
export const abs = (p1: Point) =>
  vec2.fromValues(Math.abs(p1[0]), Math.abs(p1[1]));
export const sign = (p1: Point) =>
  vec2.fromValues(Math.sign(p1[0]), Math.sign(p1[1]));
